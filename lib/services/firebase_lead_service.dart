...
class FirebaseLeadService {
  ...
  /// Deletes all leads generated by a specific user from Firestore.
  Future<void> deleteAllMyLeads(String uid) async {
    final querySnapshot = await _leads.where('addedBy', isEqualTo: uid).get();
    
    if (querySnapshot.docs.isNotEmpty) {
      // Process in chunks of 500 (Firestore batch limit)
      for (var i = 0; i < querySnapshot.docs.length; i += 500) {
        final currentBatch = _db.batch();
        final end = (i + 500 < querySnapshot.docs.length) ? i + 500 : querySnapshot.docs.length;
        for (var doc in querySnapshot.docs.sublist(i, end)) {
